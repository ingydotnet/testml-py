...
LONG_DESCRIPTION = """\
TestML is a software generic test framework.

This code will be ported to every language that is practical.

All ports will run and pass the same tests."""
AUTHOR = "Ingy döt Net"
AUTHOR_EMAIL = 'ingy@ingy.net'
LICENSE = "MIT"
PLATFORMS = "Any"
URL = "http://testml.org/"
DOWNLOAD_URL = "http://testml.org/download/python/%s-%s.tar.gz" % (NAME, VERSION)
CLASSIFIERS = [
